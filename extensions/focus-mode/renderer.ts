/**
 * Focus-mode renderer utilities
 *
 * Shared dim-style rendering functions for custom tools.
 * Import from this module so all custom tools follow the same
 * minimal, unobtrusive visual style as focus-mode's built-in overrides.
 *
